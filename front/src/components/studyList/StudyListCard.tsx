    ...
    <div className="relative bg-white dark:bg-slate-900 rounded-[24px] p-6 flex items-center justify-between border border-[#e0e2ec] dark:border-slate-800 hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition-all cursor-pointer group min-h-[104px] relative">
      <div className="flex items-center gap-5 flex-1">
        ...
        <div className="w-[60px] h-[60px] rounded-2xl bg-[#f1f3fd] dark:bg-slate-800 flex items-center justify-center text-[#0975e6] dark:text-blue-400 group-hover:bg-[#0975e6]/10 dark:group-hover:bg-blue-400/20">
          <Folder
            className="w-8 h-8 fill-[#d7e3ff] dark:fill-blue-900/50"
            strokeWidth={1.5}
          />
        </div>
                ...
                <DropdownMenu>
                  ...
                  >
                    <Button
                      data-stop
                      variant="ghost"
                      className="h-8 w-8 p-0 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full text-slate-400"
                    >
        ...
        >
          ...
          <div className="space-y-4 py-1">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="w-full bg-slate-50 dark:bg-slate-900/60 border border-slate-100/50 dark:border-slate-800/50 dark:text-slate-100 rounded-xl px-3.5 py-2.5 outline-none focus:ring-2 focus:ring-[#0975e6] text-sm transition-all"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                className="w-full bg-slate-50 dark:bg-slate-900/60 border border-slate-100/50 dark:border-slate-800/50 dark:text-slate-100 rounded-xl px-3.5 py-2.5 min-h-[90px] resize-none outline-none focus:ring-2 focus:ring-[#0975e6] text-sm transition-all"
              />
            </div>
          </div>

          {/* Visibility Card */}
          <div className="bg-slate-50/50 dark:bg-slate-900/40 rounded-xl p-3.5 flex items-center justify-between border border-slate-100/50 dark:border-slate-800/50">
            ...
            <button
              type="button"
              onClick={() =>
                setEditPrivacy(editPrivacy === "public" ? "private" : "public")
              }
            ...
            >
              <div
                className={`w-3.5 h-3.5 rounded-full bg-white absolute top-[3px] left-[3px] transition-transform duration-200 shadow-sm ${
          ...
          <div className="flex items-center justify-between gap-3 pt-1">
            <button
              ...
              className="w-[48%] py-3 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className={`w-[48%] py-3 rounded-xl text-white font-bold text-sm shadow-sm transition-all duration-200 flex items-center justify-center gap-1.5 ${
                loading || !editName
      ...
      <Dialog open={openConfirm} onOpenChange={setOpenConfirm}>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">
            Are you sure you want to delete this study list? This action cannot
            be undone.
          </p>
