...
export default function FileRow({
    ...
    return (
        <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors group">
            ...
            {/* Subject */}
            <td className="px-6 py-4">
                <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium border ${file.subjectStyle || "bg-blue-50 text-blue-600 border-blue-200"}`}>
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-sm text-slate-500 mb-4">
                                Provide a reason for rejecting: <strong className="text-slate-700 dark:text-slate-300">{file.title}</strong>
                            </p>
