...
import {
  useAdminApproveRejectFile,
  useAdminFilesStatus,
  useAdminPendingFiles,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-800 shadow-sm overflow-hidden mb-8 transition-colors">
        {/* Search Bar */}
        <div className="p-5 border-b border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col sm:flex-row justify-between items-center gap-4 transition-colors">
          ...
          <div className="flex gap-2 w-full sm:w-auto items-center">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                className="w-full pl-10 pr-8 py-2 rounded-lg border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium"
              />
              {searchTerm && (
                <button
                  onClick={() => {
        ...
        {/* Table Container */}
        <div
          className={`overflow-x-auto transition-opacity ${isFetching ? "opacity-50" : "opacity-100"}`}
        >
                  ...
                  <button
                    ...
                    className={`w-8 h-8 flex items-center justify-center rounded-md text-sm font-bold transition-colors ${
                      currentPage === page
                        ...
                        : "border border-gray-300 dark:border-slate-700 text-gray-600 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-slate-200"
                    }`}
                  >
                    {page}
                  </button>
